 ...
 * Plugin URI: https://dash10.digital/managed-services/wordpress-maintenance-service/
 * Version: 2.1.3
 ...
 * Author URI: http://dash10.digital
 * License: GPL2
 * Text Domain: wpbu
 *
 ...
 * @copyright  Blackbird Interactive 2014
 * @copyright Dash10 Digital - Barberton Ohio Web Design & Development 2018
 */
...
class WPBU_Backupware {
	...
	public function start() {
		...
		define( 'WPBU_REMOTE_HOME', 'https://dash10.digital' );
	...
	public function register_wpbu_components( $components ) {
		...
		$components['components']['wpbu_error']  = array(
			...
			'version'     => '1.0.0',
			'auhtor'      => 'Justin Greer',
			'description' => 'Reports core errors to the developers analytics server.'
		);
	...
	public function includes() {
		...
		// Include the downloader if the criteria is met
		if ( ! empty( $_REQUEST['wpbu_downloader'] ) && current_user_can( 'manage_options' ) ) {
			require_once( dirname( __FILE__ ) . '/components/downloader.php' );
		}
