...
All support matters are recommended to be place at <a href="https://dash10.digital">Dash10 Digital - Barberton Ohio Web Design + Development Company</a>. This way you will get a response sooner as this plugin has limited support. We can not guarantee support for this plugin but we will try!
...
We have removed the restore feature for the time being. If you find yourself in need of a restore, you can use phpMyAdmin to do so.
...
Although we are happy to help, We (Dash10 Digital) take no responsibility for actions done by the user using this plugin. Extreme caution should be taken whenever dealing with any database or files files.

== Upgrade Notice ==
<hr>
<i style="color:red;">Take a minute to upgrade, here's why:</i>
<li> Fixed downloader </li>
<li> Updated for PHP7 </li>
...
= 2.1.3 =
* Fixed downloader error
* Updated code formatting
* Fixed short tags issue
* Tested with WP 5.0
* Updated code for PHP 7
