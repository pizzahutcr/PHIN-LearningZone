...
function remove_block_asset_path_prefix( $asset_handle_or_path ) {
	...
	/*echo "</br>";
	echo "**************************************************************************** <br>"; //quitar
	echo "***********AQUI VA 01*********<br>"; //quitar
	var_dump($asset_handle_or_path);//quitar
	//	echo "***********AQUI VA 02*********";//quitar
	//var_dump($asset_handle_or_path[0]);//quitar
	echo "\r\n";
	echo is_array($asset_handle_or_path) ? 'Array' : 'No es un array';
	echo "<br>";*/
	//fin quitar 
	...
	//pruebas
	/*$pos = "";
	if(is_array($asset_handle_or_path)){
		$pos = strpos( $asset_handle_or_path[0], $path_prefix );
	}
	else{
		$pos = strpos( $asset_handle_or_path, $path_prefix );
	}
	
	//$pos = strpos( $asset_handle_or_path, $path_prefix );
	
	if ($pos !== false) {
     echo "La cadena '$path_prefix' fue encontrada en la cadena '$asset_handle_or_path'";
         echo " y existe en la posición $pos <br>";
} else {
     echo "La cadena '$path_prefix' no fue encontrada en la cadena '$asset_handle_or_path' <br>";
}
*/

//se modifica la v1 ya que recibe string como array y por eso generaba el error
if(is_array($asset_handle_or_path)){
	
		if ( 0 !== strpos( $asset_handle_or_path[0], $path_prefix ) ) {
			//echo "+++entro: ".$asset_handle_or_path[0]. "   ++++++ <br>"; //quitar
		return $asset_handle_or_path;
	}
	//echo "***continua**** <br>"; //quitar
	return substr(
		$asset_handle_or_path[0],
		strlen( $path_prefix )
	);
	}
	else{
		if ( 0 !== strpos( $asset_handle_or_path, $path_prefix ) ) {
			//echo "+++entro: ".$asset_handle_or_path. "   ++++++ <br>"; //quitar
		return $asset_handle_or_path;
	}
	//echo "***continua****"; //quitar
	return substr(
...
function register_block_script_handle( $metadata, $field_name ) {
	...
	//echo "aqui: ";//quitar
	//var_dump($metadata[ $field_name ]);//quitar
...
//echo "cosa: ";//quitar
//	var_dump($metadata);//quitar
//	var_dump($field_name);//quitar
