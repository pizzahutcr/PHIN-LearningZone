...
//echo "dbhost: ".$dbhost." dbuser: ".$dbuser." dbpassword:".$dbpassword." dbname: ".$dbname." ------";
		$this->dbuser     = $dbuser;
...
//echo "---entro db_connect ---  ".$this->use_mysqli." ****";
		$this->is_mysql = true;
		...
		if ( $this->use_mysqli ) {
			...
			if ( WP_DEBUG ) {
				...
				//quitar;
				//echo "dbhost: ".$this->dbhost." dbuser: ".$this->dbuser." dbpassword:".$this->dbpassword." ------";
				//**
				// phpcs:ignore WordPress.PHP.NoSilencedErrors.Discouraged
				$this->dbh = @mysql_connect( $this->dbhost, $this->dbuser, $this->dbpassword, $new_link, $client_flags );
